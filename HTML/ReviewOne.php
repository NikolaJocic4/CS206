...
<head>
    ...
    <link rel="stylesheet" href="../CSS/ReviewOne.css">
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                ...
                if(isset($_GET['id'])) {
                    ...
                    // Fetch the review details from the database based on the ID and join with the art table
                    $sql = "SELECT reviews.*, art.art_folder_destination 
                            FROM reviews 
                            INNER JOIN art ON reviews.art_name = art.art_name 
                    ...
                    if($result->num_rows > 0) {
                        ...
                        // Display the image
                        echo '<img src="../Images/' . $row['art_folder_destination'] . '" class="img-fluid" alt="Art Image">';
                    } else {
            ...
            <div class="col-md-6 d-flex flex-column justify-content-start">
                ...
                ?>
                <!-- Link with arrow and "Back" label -->
                <div class="mt-auto text-end">
                    <a href="Review.php" class="btn btn-primary bt-back"> <i class="fas fa-arrow-left"> Back</i></a>
                </div>
            </div>
        </div>
    </div>
